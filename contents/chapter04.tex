...
\begin{figure*}[htp]
    ...
    \caption[隱沒帶的兩種型態示意圖，摘自\citealp{Yan2020}]{隱沒帶的兩種型態示意圖，摘自\citealp{Yan2020}。}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=5in]{Ref_Cocosframe_200_interp_phase.png}
...
本節測試一系列數值模型參數，模型參數表\ref{模型參數列表}。
\newpage
